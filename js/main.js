...
if(mobileCheck()){
    ...
    mobile.innerHTML('Please use this site on the computer for full functionality')
...
$(document).ready(function(){
    ...
    start_section.scrollIntoView({block: "start", behavior: "auto"})
});
...
function scrollmyprojects(){
    ...
    myprojects.scrollIntoView({block: "center", behavior: "smooth"});
}
...
window.addEventListener("load", () =>{
    ...
    anime({
        ...
        easing: 'linear',
        update: function(){
            loading.innerHTML = loadingobject.charged;
        },
        complete: function(){
            var startelements = $('[id=start]');
            var startheader = document.getElementById('start_header');
...
if(!mobileCheck()){
        ...
        window.onscroll = function(){
            ...
            if(window.pageYOffset == aboutmesection.offsetTop){
